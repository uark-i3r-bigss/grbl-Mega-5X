...
/* The defaults.h file serves as a central default settings selector for different machine
   ...
   NOTE: Ensure one and only one of these DEFAULTS_XXX values is defined in config.h */
    ...
    #define DEFAULT_AXIS3_MAX_TRAVEL 65.0 // mm
        ...
        #define DEFAULT_AXIS5_ACCELERATION (750.0*60*60) // 750*60*60 mm/min^2 = 100 mm/sec^2
        #define DEFAULT_AXIS5_MAX_TRAVEL .0 // °
      ...
      #endif
    #endif
    #define DEFAULT_SPINDLE_RPM_MAX 100.0 // rpm - Laser power percentage
